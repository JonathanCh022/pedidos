            ...
            <div class="container-fluid">
                ...
                <!-- InstanceBeginEditable name="EditRegion1" -->
                    <div class="col-lg-12" style="margin-top: 50px; ">
                      <h1 class="page-header">Cargar Rutero</h1>
                    </div>
                    <div style="margin-top: 50px; ">
                        <h5>Cargue el archivo .csv con el siguiente orden pre-establecido <br><br> Codigo vendedor | Dia | Codigo cliente | Orden </h5>
                    </div>
                    <div style="margin-top: 60px; ">
                        <form name="form1" method="POST" action="cargarut.php" enctype="multipart/form-data">
                            <label>Escoga el archivo con la tabla de las rutas: </label>
                            <input id="uploadFile" placeholder="Choose File" disabled="disabled" value="" />
                            <div class="fileUpload btn btn-primary">
                                <span>Upload</span>
                                <input id="uploadBtn" type="file" class="upload" name="rut" />
                            </div>
                      ...
                      <div id="light" class="modal-body" style="background-color:#f5f5f0; ">
                           <div id="exito" class="panel " style="display:none;">
                                <div class="panel-body " >
                                    ...
                                    <h3 class="text-center">Rutero cargado satisfactoriamente.</h3>
                                </div>               
                            </div>
