            ...
            <div class="container-fluid">
                ...
                <!-- InstanceBeginEditable name="EditRegion1" -->
                    ...
                    <div style="margin-top: 50px; ">
                        <h5>Cargue el archivo .csv con el siguiente orden pre-establecido <br><br>  Referencia | Descripcion | Porcentaje IVA | Precio de venta | Existencias | Pedidas </h5>
                    </div>
                    <div style="margin-top: 60px; ">
                        <form name="form1" method="POST" action="cargainv.php" enctype="multipart/form-data">
                            <label>Escoga el archivo con la lista del inventario: </label>
                            <input id="uploadFile" placeholder="Choose File" disabled="disabled" value="" />
                            <div class="fileUpload btn btn-primary">
                                <span>Upload</span>
                                <input id="uploadBtn" type="file" class="upload" name="inv" />
                            </div>
                      ...
                      <div id="light" class="modal-body" style="background-color:#f5f5f0; ">
                           <div id="exito" class="panel " style="display:none;">
                                <div class="panel-body " >
                                    ...
                                    <h3 class="text-center">Inventario cargado satisfactoriamente.</h3>
                                </div>               
                            </div>
