            ...
            <div class="container-fluid">
                ...
                <!-- InstanceBeginEditable name="EditRegion1" -->
                    <div class="col-lg-12" style="margin-top: 50px; ">
                      <h1 class="page-header">Cargar Clientes</h1>
                    </div>
                    <div style="margin-top: 50px; ">
                        <h5>Cargue el archivo .csv con el siguiente orden pre-establecido <br><br> Cedula cliente | Codigo vendedor | Nombre cliente | Negocio cliente | Direccion cliente | Email cliente | Telefono cliente | latitud | longitud </h5>
                    </div>
                    <div style="margin-top: 60px; ">
                        <form name="form1" method="POST" action="cargaclt.php" enctype="multipart/form-data">
                            <label>Escoga el archivo con la lista de los clientes: </label>
                            <input id="uploadFile" placeholder="Choose File" disabled="disabled" value="" />
                            <div class="fileUpload btn btn-primary">
                                <span>Upload</span>
                                <input id="uploadBtn" type="file" class="upload" name="clt" />
                            </div>
                      ...
                      <div id="light" class="modal-body" style="background-color:#f5f5f0; ">
                           <div id="exito" class="panel " style="display:none;">
                                <div class="panel-body " >
                                    ...
                                    <h3 class="text-center">Clientes cargados satisfactoriamente.</h3>
                                </div>               
                            </div>
