...
header("Content-Type: text/html;charset=utf-8");
  ...
  $index = $_POST['i'];
  $sqlgeneral="INSERT INTO pedido_general (pdg_numero,pdg_fecha,pdg_cliente,pdg_estado,pdg_vendedor,pdg_hora,pdg_latitud,pdg_longitud) VALUES ('".$_POST['npedido']."','$fech','".$_POST['cliente']."','1','".$_POST['vendedor']."','$time','0','0')";
